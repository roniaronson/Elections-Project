...
public class SickSoldier extends Soldier implements Sickable{
	...
	public SickSoldier(String name, int id, int year, String wichBallot, boolean carryWeapon, boolean protectiveSuit, int howManyDays) {
		super(name,id,year,wichBallot, carryWeapon);
