...
public class SickCandidate extends Candidate implements Sickable {
	...
	public SickCandidate(String name, int id, int year, String wichBallot, int placement, String politicalPartyName, boolean protectiveSuit, int howManyDays) {
		super(name,id,year,wichBallot, placement,politicalPartyName);
